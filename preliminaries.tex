...
A planar graph is a graph that can be embedded in the plane. It can be drawn on the plane in such a way that its edges intersect only at their endpoints. In other words, it can be drawn in such a way that no edges cross each other. \Cref{fig:planar} shows multiple planar embeddings of the same planar graphs.
\\
